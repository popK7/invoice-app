            ...
            <tbody>
                <tr>
                    <td style="padding:25px 25px 0; color: #161c2d;">
                        <p style="margin: 0;color: #718096;">You have registered with {{ config('app.name'); }} as {{$role}}.</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 25px 25px; color: #161c2d;text-align: center;">
                        ...
                        <p style="margin: 0;color: #718096;">Password : {{$password}}</p>

                        <p style="margin: 15px 0 0;color: #718096;font-size: 14px;"><b>Please verify your account before login</b></p>
                        <a href="{{$app_url}}verify-account/{{ $token }}/{{ $email }}" target="_blank">Confirm Email Address</a>
