                                    ...
                                    <div class="row g-0">
                                        <div class="col-lg-6">
                                            <div class="p-lg-5 p-4">
                                                ...
                                                <div class="mt-4">
                                                    <form action="{{url('forget-password')}}" method="POST" name="loginForm" class="auth-input" onsubmit="return validateform()">
                                                        @csrf
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Wait, I remember my password... <a href="{{url('/')}}" class="fw-medium text-primary text-decoration-underline"> Click here </a> </p>
                                                        </div>
                                                    </form>
                                                </div>
