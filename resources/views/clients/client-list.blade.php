...
@section('title') {{__('translation.Clients')}} @endsection
@section('css')
<!-- Sweet Alert css-->
...
<body>
    ...
    @slot('title') {{__('translation.Clients')}} @endslot
    @slot('pagetitle') {{__('translation.Client List')}} @endslot
    @endcomponent

    <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            <button class="btn btn-primary addPayment-modal" data-bs-toggle="modal" data-bs-target="#addClientModal"><i class="las la-plus me-1"></i> {{__('translation.Add Client')}}</button>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive table-card">
                        <table class="table table-hover table-nowrap align-middle mb-0" id="clientListTable">
                            <thead>
                        ...
                        <input type="hidden" id="first_name_{{$client['id']}}" value="{{@$client['first_name']}}">
                        <input type="hidden" id="last_name_{{$client['id']}}" value="{{@$client['last_name']}}">
                        <input type="hidden" id="email_{{$client['id']}}" value="{{@$client['email']}}">
                        <input type="hidden" id="username_{{$client['id']}}" value="{{@$client['username']}}">
                        <input type="hidden" id="country_{{$client['id']}}" value="{{@$client['country']}}">
                        <input type="hidden" id="mobile_number_{{$client['id']}}" value="{{@$client['mobile_number']}}">
                        <input type="hidden" id="profile_image_{{$client['id']}}" value="{{ URL::asset('assets/images/users/' . $client['profile_image']) }}">
                        <input type="hidden" id="company_name_{{$client['id']}}" value="{{@$client['clientDetails']['company_name']}}">
                        <input type="hidden" id="gst_number_{{$client['id']}}" value="{{@$client['clientDetails']['gst_number']}}">
                        <input type="hidden" id="company_code_{{$client['id']}}" value="{{@$client['clientDetails']['company_code']}}">
                        <input type="hidden" id="address_{{$client['id']}}" value="{{@$client['clientDetails']['address']}}">
                        @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <div class="modal-body p-4">
                    <form method="POST" action="{{url('add-client')}}" autocomplete="off" id="clientform" class="needs-validation" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="text-center mb-2">
                                    <div class="position-relative d-inline-block">
                                        <div class="position-absolute bottom-0 end-0">
                                            <label for="member-image-input" class="mb-0" data-bs-toggle="tooltip" data-bs-placement="right" title="Select Client Image">
                                                <div class="avatar-xs">
                                ...
                                <hr>
                                <div class="d-flex p-2 bg-success bg-gradient text-white"><strong>{{__('translation.Company Details')}}</strong></div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-2 mt-2">
                                        <label for="gst_number" class="form-label">{{__('translation.GST Number')}}</label>
                                        <input type="text" class="form-control @error('gst_number') is-invalid @enderror" id="gst_number" name="gst_number" placeholder="Enter GST">
                                    ...
                                    <div class="col-lg-6 mb-2 mt-2">
                                        <label for="company_code" class="form-label">{{__('translation.Company Code')}}<span class="text-danger">*</span></label>
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('company_code') is-invalid @enderror" id="company_code" name="company_code" placeholder="Enter company code" required>
                                            <button type="button" class="btn btn-success position-absolute top-0 end-0" id="generateCode" data-bs-toggle="tooltip" data-bs-placement="right" title="Generat Random" onclick="randomValue();"><i class="las la-random"></i></button>
                                ...
                                <div class="mb-2 mt-2">
                                    <label for="companyAddress" class="form-label">{{__('translation.Company Address')}}<span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('company_address') is-invalid @enderror" id="companyAddress" name="company_address" placeholder="Enter company address" required rows="4"></textarea>
                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success" id="addNewClient">{{__('translation.Add Client')}}</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade" id="editClientModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <div class="modal-body p-4">
                    <form method="POST" action="{{url('update-client')}}" autocomplete="off" id="clientform" class="needs-validation" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="hidden" id="memberid-input" class="form-control" value="">
                                ...
                                <div class="text-center mb-2">
                                    <div class="position-relative d-inline-block">
                                        <div class="position-absolute bottom-0 end-0">
                                            <label for="editClientProfile" class="mb-0" data-bs-toggle="tooltip" data-bs-placement="right" title="Select Client Image">
                                                <div class="avatar-xs">
                                                    <div class="avatar-title bg-light border rounded-circle text-muted cursor-pointer">
                                                        <i class="ri-image-fill"></i>
                                                    </div>
                                            ...
                                            <input class="form-control d-none @error('profile_image') is-invalid @enderror" value="" id="editClientProfile" type="file" name="profile_image" accept="image/png, image/gif, image/jpeg" onchange="editProfile(this)">
                                            <div class="invalid-feedback">Please select image.</div>
                                        </div>
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded-circle">
                                                <img src="{{URL::asset('/assets/images/users/user-dummy-img.jpg')}}" id="editClientImage" class="avatar-md rounded-circle h-auto" />
                                            </div>
                                        </div>
                                    </div>
                                    @error('profile_image')
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-2 mt-2">
                                        <label for="editGstNumber" class="form-label">{{ __('translation.GST Number') }}</label>
                                        <input type="text" class="form-control @error('gst_number') is-invalid @enderror" id="editGstNumber" name="gst_number" placeholder="Enter GST">
                                    ...
                                    <div class="col-lg-6 mb-2 mt-2">
                                        <label for="editCompanyCode" class="form-label">{{ __('translation.Company Code') }}<span class="text-danger">*</span></label>
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('company_code') is-invalid @enderror" id="editCompanyCode" name="company_code" placeholder="Enter company code" required>
                                            <button type="button" class="btn btn-success position-absolute top-0 end-0" id="editGenerateCode" data-bs-toggle="tooltip" data-bs-placement="right" title="Generat Random" onclick="editRandomValue();"><i class="las la-random"></i></button>
                                ...
                                <div class="mb-2 mt-2">
                                    <label for="editAddress" class="form-label">{{ __('translation.Company Address') }}<span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('company_address') is-invalid @enderror" id="editAddress" name="address" placeholder="Enter company address" required rows="4"></textarea>
                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                                    <button type="submit" class="btn btn-success" id="addNewClient">{{ __('translation.Update Client') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="text-center mb-2">
                                    <div class="position-relative d-inline-block">
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded-circle">
                                                <img src="{{URL::asset('/assets/images/users/user-dummy-img.jpg')}}" id="viewClientImage" class="avatar-md rounded-circle h-auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2 mt-2">
                                        <label for="company_code" class="form-label">{{ __('translation.Company Code') }}<span class="text-danger">*</span></label>
                                        <div class="position-relative">
                                            <input type="text" class="form-control" id="viewCompanyCode" readonly>
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-2 mt-2">
                                    <label for="address" class="form-label">{{ __('translation.Company Address') }}<span class="text-danger">*</span></label>
    ...
    <script>
        ...
        (function() {
            ...
            function viewClientData(clientId) {
                if (clientId) {
                    document.getElementById('viewFirstName').value = document.getElementById('first_name_' + clientId).value;
                    document.getElementById('viewLastName').value = document.getElementById('last_name_' + clientId).value;
                    document.getElementById('viewEmail').value = document.getElementById('email_' + clientId).value;
                    document.getElementById('viewUsername').value = document.getElementById('username_' + clientId).value;
                    document.getElementById('viewCountry').value = document.getElementById('country_' + clientId).value;
                    document.getElementById('viewMobileNumber').value = document.getElementById('mobile_number_' + clientId).value;
                    document.getElementById('viewCompanyName').value = document.getElementById('company_name_' + clientId).value;
                    document.getElementById('viewGstNumber').value = document.getElementById('gst_number_' + clientId).value;
                    document.getElementById('viewCompanyCode').value = document.getElementById('company_code_' + clientId).value;
                    document.getElementById('viewAddress').value = document.getElementById('address_' + clientId).value;
                    document.getElementById("viewClientImage").src = document.getElementById('profile_image_' + clientId).value;
                }
            }

            function editClientData(clientId) {
                if (clientId) {
                    document.getElementById('editFirstName').value = document.getElementById('first_name_' + clientId).value;
                    document.getElementById('editLastName').value = document.getElementById('last_name_' + clientId).value;
                    document.getElementById('editEmail').value = document.getElementById('email_' + clientId).value;
                    document.getElementById('editUsername').value = document.getElementById('username_' + clientId).value;
                    document.getElementById('editCountry').value = document.getElementById('country_' + clientId).value;
                    document.getElementById('editMobileNumber').value = document.getElementById('mobile_number_' + clientId).value;
                    document.getElementById('editCompanyName').value = document.getElementById('company_name_' + clientId).value;
                    document.getElementById('editGstNumber').value = document.getElementById('gst_number_' + clientId).value;
                    document.getElementById('editCompanyCode').value = document.getElementById('company_code_' + clientId).value;
                    document.getElementById('editAddress').value = document.getElementById('address_' + clientId).value;
                    document.getElementById("editClientImage").src = document.getElementById('profile_image_' + clientId).value;
