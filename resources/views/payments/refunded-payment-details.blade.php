            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('pending-payment')}}" role="tab" aria-selected="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{url('refunded-payment')}}" role="tab" aria-selected="false">
